...
data class CapabilityResponse(
    ...
    companion object CREATOR : Parcelable.Creator<CapabilityResponse> {
        override fun createFromParcel(parcel: Parcel): CapabilityResponse {
            return CapabilityResponse(parcel)
        }

        override fun newArray(size: Int): Array<CapabilityResponse?> {
